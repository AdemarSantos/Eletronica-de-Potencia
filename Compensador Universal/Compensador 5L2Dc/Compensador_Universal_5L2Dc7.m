...
Vgm = 250*sqrt(2);       % Tensão de pico da rede (Vgm)
...
Vc3L = 340;         % Tensão medida no barramento 3L (Conv. A)          
Ea = Vc3L_ref; 

% Barramento 2L
Vc2L_ref = 340;          % Tensão de referência do barramento 2L (Conv. B)
Vc2L = 340;         % Tensão medida no barramento 2L (Conv. B) 
Eb = Vc2L_ref;
...
npt = 3000000;             % Dimensão do vetor de saída de dados
...
vc3L_int = Vc3L;         % Valor inicial p/ média da tensão do barramento
...
%         vgb_refs(n) = vgbn_ref;
        ...
        %% Tensão média do barramento
        vc3L_meds(n) = vc3L_med; 
    end
end
%% ---------------- Fim do Looping ----------------
