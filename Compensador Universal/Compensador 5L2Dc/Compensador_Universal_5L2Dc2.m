...
Vgm = 233;       % Tensão RMS de entrada (eg)
...
%         vg_ref = Vg_ref*sqrt(2)*cos(w_ref*t);
...
%         control = -1; % Descarregar Sempre
    ...
    if tete >= 2*pi
        tete = tete - 2*pi;
        Pot2Lmax_total = Pot2Lmax/cont1;
        Pot2Lmin_total = Pot2Lmin/cont2;
        Pot2Lmax = 0;
        Pot2Lmin = 0;
        cont1 = 0;
        cont2 = 0;
...
% 
% figure(14)
% plot(Ts,Potcs,'LineWidth',2)
% title('Potência de carregamento','FontSize',18)
% legend('Potência de Carregamento','FontSize',16)
% xlabel("Tempo (s)")
% ylabel("Potência (W)")
% 
% figure(15)
% plot(Ts,Potds,'LineWidth',2)
% title('Potência de descarregamento','FontSize',18)
% legend('Potência de Descarregamento','FontSize',16)
% xlabel("Tempo (s)")
% ylabel("Potência (W)")