...
%             vxmaxgba =  (Vc2L+Vc3L/2) - vsh_ref;
%             vxmingba = -(Vc2L+Vc3L/2) - vsh_ref;
%             vxmaxl0  =  Vc3L/2 - max([vse_ref,0]);
%             vxminl0  = -Vc3L/2 - min([vse_ref,0]);
...
legend('$E_{a_{med}}$','$E_{a_{ref}}$','FontSize',16,'Interpreter','latex','Location','northwest')
...
sp2 = subplot(3,1,2);
plot(Ts,Vc2Ls,Ts,Vc2L_refs,'r--',...
    [tsave0 tf/2],[180+delta 180+delta],'k-',...
    [tsave0 tf/2],[180-delta 180-delta],'k-',...
    [tf/2 tf],[Vc2L_ref+delta Vc2L_ref+delta],'k-',...
    [tf/2 tf],[Vc2L_ref-delta Vc2L_ref-delta],'k-'),zoom
title('Barramento $E_b$','FontSize',18,'Interpreter','latex')
legend('$E_{b_{med}}$','$E_{b_{ref}}$','FontSize',16,'Interpreter','latex','Location','northwest')
xlabel('Tempo (s)','FontSize',14)
ylabel('Tensão (V)','FontSize',14)
grid('minor')
axis(ax2);
